...
- **Architecture details** (state-machine dispatcher, fallback mechanism, exposure system, memory tiers): See [references/architecture.md](references/architecture.md)
