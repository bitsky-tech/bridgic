...
2. [Parameter Resolving](../core_mechanism/parameter_binding): Explore three ways for passing data and two ways for dispatching data between execution units, including Arguments Mapping, Arguments Injection, and Inputs Propagation about parameter binding; including Input Dispatching and Result Dispatching.
